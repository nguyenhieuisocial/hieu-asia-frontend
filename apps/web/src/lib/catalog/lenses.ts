...
export const LENSES: Lens[] = [
  ...
  },
  {
    slug: 'bat-tu',
    name: 'Bát Tự',
    role: 'thời điểm để ra quyết định',
    full: 'Tứ Trụ can-chi — Nhật Chủ là chính bạn; ngũ hành cho biết thời điểm thuận để hành động.',
    give: 'thời điểm thuận để hành động',
    meta: 'Tứ Trụ can-chi · Nhật Chủ',
    eyebrow: 'BÁT TỰ · TỨ TRỤ',
    title: 'Chọn đúng thời điểm',
    cta: 'Đọc về Bát Tự',
    href: '/learn/bat-tu',
    serviceDesc: 'Lập Tứ Trụ Bát Tự, đọc Nhật Chủ và thời điểm thuận để hành động theo ngũ hành.',
