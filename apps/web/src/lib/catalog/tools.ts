...
export const TOOLKIT_GROUPS: ToolGroup[] = [
  {
    ...
    tools: [
      ...
      { n: 'Cân Xương', href: '/can-xuong', learn: '/learn/can-xuong' },
      { n: 'Thước Lỗ Ban', href: '/thuoc-lo-ban', learn: '/learn/phong-thuy' },
      { n: 'Hợp tuổi', href: '/hop-tuoi', learn: '/learn/hop-tuoi' },
      { n: 'Lịch vạn niên', href: '/lich-van-nien', learn: '/learn/trach-cat' },
      { n: 'Xem ngày tốt', href: '/xem-ngay', learn: '/learn/trach-cat' },
      { n: 'Sao hạn', href: '/sao-han', learn: '/learn/sao-han' },
      { n: 'Giờ hoàng đạo', href: '/gio-hoang-dao', learn: '/learn/trach-cat' },
      { n: 'Lịch thiên văn', href: '/thien-van', learn: '/learn/trach-cat' },
      { n: 'Ngày kiêng kỵ', href: '/ngay-kieng-ky', learn: '/learn/trach-cat' },
      { n: 'Đặt tên ngũ hành', href: '/dat-ten-ngu-hanh', learn: '/learn/dat-ten-ngu-hanh' },
    ],
  },
  {
