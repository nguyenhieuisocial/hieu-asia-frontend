...
export const QUICK_LOOKUP: QuickTool[] = [
  ...
  { href: '/sao-han', label: 'Xem sao hạn', tier: 'free' },
  { href: '/gio-hoang-dao', label: 'Giờ hoàng đạo', tier: 'free' },
  { href: '/thien-van', label: 'Lịch thiên văn', tier: 'free' },
  { href: '/ngay-kieng-ky', label: 'Ngày kiêng kỵ', tier: 'free' },
  { href: '/dat-ten-ngu-hanh', label: 'Đặt tên ngũ hành', tier: 'free' },
