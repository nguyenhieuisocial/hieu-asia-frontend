      ...
      <div className="mx-auto max-w-3xl space-y-6">
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-xl border border-gold/25 bg-gold/5 p-4">
            <div className="font-mono text-eyebrow uppercase text-gold/80">Nghĩa xuôi</div>
          ...
          <div className="rounded-xl border border-border bg-card/40 p-4">
            <div className="font-mono text-eyebrow uppercase text-muted-foreground">Nghĩa ngược</div>
            <div className="mt-2 flex flex-wrap gap-1.5">
              {c.keyRev.map((k) => (
