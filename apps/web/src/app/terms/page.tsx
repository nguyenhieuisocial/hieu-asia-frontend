    ...
    <main className="min-h-screen bg-ink text-cream">
      ...
      <section className="container mx-auto max-w-3xl px-6 pb-20 pt-6">
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-2 text-sm leading-relaxed text-cream/85">
            <ul className="list-disc space-y-2 pl-5">
              <li>
                <strong className="text-cream">"Dịch vụ"</strong>: nền tảng phân tích cá nhân AI tại
                hieu.asia và các kênh liên kết (Telegram bot, miniapp).
              </li>
              <li>
                <strong className="text-cream">"Người dùng"</strong>: cá nhân tạo tài khoản hoặc sử
                dụng dịch vụ.
              </li>
              <li>
                <strong className="text-cream">"Báo cáo"</strong>: nội dung phân tích cá nhân được hệ
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-3 text-sm leading-relaxed text-cream/85">
            ...
            <p className="font-semibold text-cream">
              hieu.asia <strong className="text-gold">KHÔNG</strong> phải:
            </p>
            <ul className="list-disc space-y-2 pl-5">
        ...
        <Card className="mb-6 border-gold/40">
          ...
          <CardContent className="space-y-3 text-sm leading-relaxed text-cream/85">
            <div className="rounded-md border border-gold/30 bg-gold/10 p-4">
              <p className="font-semibold text-cream">
                Báo cáo hieu.asia có tính chất <strong className="text-gold">tham khảo</strong>, KHÔNG
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-3 text-sm leading-relaxed text-cream/85">
            <p>
              Thanh toán được xử lý qua <strong className="text-cream">SePay</strong> — đối tác thanh
        ...
        <Card className="mb-6">
          ...
          <CardContent className="text-sm leading-relaxed text-cream/85">
            <p>
              ...
              <strong className="text-cream">nước Cộng hoà Xã hội Chủ nghĩa Việt Nam</strong>. Tranh
        ...
        <Card className="mb-6">
          ...
          <CardContent className="text-sm leading-relaxed text-cream/85">
            <p>
              ...
              lần cuối ngày <span className="text-gold">{LAST_UPDATED}</span>. Việc tiếp tục sử dụng
