...
export const metadata: Metadata = {
  title: 'Xem hợp nhóm & gia đình (3–6 người) — hoà hợp & gợi ý phối hợp',
  description:
    'Thêm 3–6 người (gia đình, nhóm bạn, đội nhóm) để xem điểm hoà hợp chung, mức hợp từng cặp, vai trò mỗi người và những cặp nên chú ý giao tiếp. Miễn phí, không dán nhãn hợp/khắc.',
