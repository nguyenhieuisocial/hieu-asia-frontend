        ...
        <div className="rounded-2xl border border-gold/25 bg-gradient-to-br from-gold/10 to-transparent p-6">
          <div className="flex flex-wrap items-center justify-between gap-6">
            ...
            <div className="min-w-0 flex-1">
              <div className="font-mono text-[12px] uppercase tracking-[0.12em] text-gold/80">Cấu trúc quẻ</div>
            ...
            <ol className="mt-4 space-y-4">
              {haoList.map((h) => (
                <li key={h.line} className="border-l-2 border-gold/25 pl-4">
                  <div className="font-mono text-[13px] uppercase tracking-[0.12em] text-gold/80">
                    Hào {h.line} · {h.label}
                  </div>
