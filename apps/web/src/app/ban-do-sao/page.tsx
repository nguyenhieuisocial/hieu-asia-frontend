    ...
    <>
      ...
      >
        <section className="space-y-8">
              ...
              {ZODIAC.map((s) => (
                <div key={s.idx} className="rounded-xl border border-border bg-background/40 p-4">
                  <div className="flex items-baseline justify-between gap-2">
                    ...
                    <span className="shrink-0 rounded-full bg-muted px-2 py-0.5 text-[13px] text-muted-foreground">
                      {s.element} · {s.quality}
                    </span>
                  </div>
          ...
          {/* Lời nhắn */}
          <section className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-sm">
            <h2 className="font-mono text-eyebrow uppercase text-gold/80">Một lời nhắn</h2>
