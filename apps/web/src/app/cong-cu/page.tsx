...
const TOOLS: ExplorerTool[] = [
  ...
  { cat: 'xem-tuoi', href: '/kim-lau', emoji: '💍', name: 'Kim Lâu', desc: 'Tuổi Kim Lâu cô dâu là gì, năm nào phạm? Tra theo tuổi mụ (chia 9) — phong tục cưới hỏi để tham khảo, không hù dọa.' },
  ...
  { cat: 'xem-tuoi', href: '/phi-tinh', emoji: '🧭', name: 'Huyền Không Phi Tinh', desc: 'Lập bàn phi tinh 9 cung theo nguyên vận + hướng nhà: vận/sơn/hướng tinh, phán Vượng sơn Vượng hướng. Lý khí, con số thật.' },
