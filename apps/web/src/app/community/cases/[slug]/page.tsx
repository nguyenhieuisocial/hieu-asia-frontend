      ...
      <main id="main-content" className="min-h-screen bg-ink text-cream pt-16">
        <article className="mx-auto max-w-3xl px-6 py-12 sm:py-16">
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-sm text-cream/70 transition-colors hover:text-gold"
          >
          ...
          <Section title="Hồi tưởng (người dùng tự kể)">
            <blockquote className="border-l-2 border-gold/40 pl-5 italic text-cream/85">
              {c.reflection}
            </blockquote>
          </Section>
          ...
          <aside className="mt-12 rounded-2xl border border-cream/10 bg-ink/40 p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm leading-relaxed text-cream/75">
                <p className="font-medium text-cream/90">Cam kết riêng tư</p>
                <p className="mt-1">
          ...
          <div className="mt-8 rounded-2xl border border-gold/20 bg-gradient-to-br from-gold/8 via-ink to-purple/15 p-6 text-center">
...
function Section({
  ...
  return (
    <section className="mt-8 first:mt-0">
      ...
      <div className="mt-3 text-base leading-relaxed text-cream/85">
        {children}
      </div>
    </section>
  );
