...
const CHANNELS = [
  ...
  },
  {
    href: '/learn',
    label: 'Học huyền học',
    desc: '18 chủ đề nền tảng: Tử Vi, Bát Tự, MBTI, Big Five, DISC, Enneagram, Tarot, Kinh Dịch, chiêm tinh, xem tướng, thần số, 12 con giáp, sao hạn…',
    icon: BookOpen,
    cta: 'Vào thư viện',
    external: false,
    status: 'live' as const,
  ...
  },
  {
    ...
    label: 'Case studies',
    desc: '6 tình huống minh hoạ cách dùng lá số cho một quyết định thật — kèm các trang Methodology liên quan.',
    icon: FileText,
    cta: 'Đọc 6 tình huống',
    external: false,
    status: 'live' as const,
  },
  {
      ...
      <main id="main-content" className="min-h-screen bg-background text-foreground pt-16">
        ...
        <section className="relative isolate overflow-hidden bg-background">
          ...
          <div className="mx-auto max-w-4xl px-6 py-16 text-center sm:py-24">
            <p className="font-mono text-[12px] uppercase tracking-[0.12em] text-gold-700 sm:text-xs">
              Cộng đồng
            </p>
  ...
  return (
    <Wrapper>
      <div className="flex items-start justify-between">
        ...
        {isSoon && (
          <span className="font-mono text-[12px] uppercase tracking-[0.12em] text-gold/85">
            Sắp ra mắt
          </span>
        )}
      </div>
