...
/**
 * Năm khởi công chính của cụm trang.
 *
 * Trước đây là hằng số gõ tay kèm ghi chú "cập nhật mỗi mùa xây dựng" — nhưng
 * không ai nhắc thì không ai cập nhật, và dựng lại web KHÔNG chữa được vì đó là
