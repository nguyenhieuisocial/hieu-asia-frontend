...
/**
 * Segment error boundary for the checkout flow (/checkout/*).
    ...
    >
      <div className="mx-auto max-w-lg space-y-6 text-center">
        ...
        <Alert variant="destructive" className="text-left">
          <p className="text-sm">
            Đã có sự cố khi xử lý đơn hàng. Nếu bạn đã thanh toán, giao dịch
            không bị ảnh hưởng. Bạn có thể thử lại hoặc quay về trang chủ.
          </p>
          {error.message && (
