      ...
      >
        <section className="space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-sm">
            ...
            <p className="mt-3 font-mono text-[13px] text-muted-foreground sm:hidden" aria-hidden="true">
              ← vuốt ngang →
            </p>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-sm">
            <h2 className="font-mono text-eyebrow uppercase text-gold/80">Câu hỏi thường gặp</h2>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-sm">
            <h2 className="font-mono text-eyebrow uppercase text-gold/80">Xem theo năm sinh</h2>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6 backdrop-blur-sm">
            <h2 className="font-mono text-eyebrow uppercase text-gold/80">Nhận nhắc theo mùa</h2>
            <OccasionLeadCapture
