...
const FAQS = [
  {
    q: 'Bát Tự là gì?',
    a: 'Bát Tự (八字) nghĩa là 8 chữ. Mỗi trụ trong 4 trụ có 1 Thiên Can (天干 — 10 can: Giáp, Ất, Bính, Đinh, Mậu, Kỷ, Canh, Tân, Nhâm, Quý) và 1 Địa Chi (地支 — 12 chi: Tý, Sửu, Dần, Mão...). Tổng cộng 8 ký tự.',
  },
  {
    q: 'Ngũ Hành là gì?',
    a: '5 yếu tố cơ bản: Kim (kim loại), Mộc (cây), Thủy (nước), Hỏa (lửa), Thổ (đất). Chúng tương sinh – tương khắc. Mỗi Can/Chi mang một hành. Sự cân bằng giữa các hành trong lá Bát Tự cho biết thiên hướng, điểm thừa, điểm thiếu.',
  },
  {
    q: 'Ý nghĩa từng trụ?',
