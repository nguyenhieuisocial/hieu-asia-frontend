    ...
    <main className="mx-auto max-w-4xl px-6 py-12 sm:py-16">
      ...
      <section className="mt-10">
        ...
        <Accordion type="single" collapsible className="space-y-2">
          <AccordionItem value="basics" className="rounded border border-cream/10 px-4">
          ...
          <AccordionItem value="five" className="rounded border border-cream/10 px-4">
          ...
          <AccordionItem value="pillar" className="rounded border border-cream/10 px-4">
          ...
          <AccordionItem value="diff" className="rounded border border-cream/10 px-4">
