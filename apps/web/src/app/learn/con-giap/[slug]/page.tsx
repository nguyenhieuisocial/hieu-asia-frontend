  ...
  return (
    <>
      ...
      <section className="relative mx-auto max-w-3xl px-6 pb-10 pt-6 sm:pt-8">
        ...
        <p className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-gold/30 bg-gold/[0.06] px-3 py-1 font-mono text-eyebrow uppercase text-gold-700">
          Ngũ hành {z.nguHanh}
        </p>
      ...
      <section className="relative mx-auto max-w-3xl px-6 pb-10">
        <div className="rounded-xl border border-border bg-card/40 p-5">
          <p className="flex items-center gap-2 font-mono text-eyebrow uppercase text-gold-700">
