...
export const metadata: Metadata = {
  ...
  description:
    'Tử Vi, Bát Tự, MBTI, Big Five, DISC, Enneagram, Tarot, Kinh Dịch, chiêm tinh, thần số, con giáp, sao hạn… 15 chủ đề, infographic trực quan, ngôn ngữ Việt.',
          ...
          <Link key={t.href} href={t.href} className="group">
            <Card className="h-full border-border bg-card/40 backdrop-blur-sm transition-all duration-300 group-hover:-translate-y-1 group-hover:border-gold/40 group-hover:shadow-[0_0_40px_-12px_rgba(184,146,61,0.4)]">
              <CardHeader>
                ...
                <CardDescription className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted-foreground">
                  {t.subtitle}
                </CardDescription>
              </CardHeader>
              <CardContent>
