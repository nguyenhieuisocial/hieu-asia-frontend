...
export default function ThanSoHocResultPage() {
  return (
    <React.Suspense fallback={null}>
      <ThanSoHocResultPageInner />
    </React.Suspense>
  );
}

function ThanSoHocResultPageInner() {
      ...
      <CardContent className="relative p-6 sm:p-8">
        <div className="flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:gap-8">
          <div className="flex flex-col items-start">
            <div className="font-mono text-eyebrow uppercase text-gold-700">
              Đường đời · Life Path
            </div>
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-border bg-card/40 px-3 py-1 font-mono text-[13px] tracking-wide text-muted-foreground">
    ...
    <Card className="relative overflow-hidden border-gold/30 bg-gradient-to-br from-gold/15 via-card/40 to-gold/10">
      ...
      <CardContent className="relative flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between sm:p-8">
        <div className="max-w-xl">
          <div className="inline-flex items-center gap-1.5 rounded-full border border-gold/40 bg-gold/10 px-2.5 py-0.5 font-mono text-eyebrow uppercase text-gold-700">
