...
/**
 * Wave 60.58 T2.1 — /account/payments
 *
 * Hierarchical deep route extracted from the former PaymentsTab. The
 * content component (PaymentsTab) is kept as-is — it still renders the
 * same Subscription + Lịch sử giao dịch cards. Wave 60.58 T3.x can rename
 * /delete it once we confirm no other importers exist; for now we just
 * wrap it in the standard authed-shell + breadcrumb pattern matching
