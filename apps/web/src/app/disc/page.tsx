                ...
                <Card className="border-gold/20 bg-card/50">
                  <CardContent className="space-y-4 p-6">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div>
                        <div className="font-mono text-eyebrow uppercase text-emerald-300">
                          Điểm mạnh nổi bật
                        </div>
                      ...
                      <div>
                        <div className="font-mono text-eyebrow uppercase text-amber-300">
                          Hướng phát triển
                        </div>
                        <ul className="mt-1.5 space-y-1 text-sm leading-relaxed text-foreground/85">
                    ...
                    <div>
                      <div className="font-mono text-eyebrow uppercase text-gold">
                        Giao tiếp &amp; làm việc
                      </div>
