      ...
      <CardContent className="space-y-4">
        ...
        {result && (
          <div ref={resultRef} className="scroll-mt-24 space-y-5">
            ...
            <div>
              <h3 className="font-mono text-eyebrow uppercase text-emerald-700 dark:text-emerald-300">
            ...
            <div>
              <h3 className="font-mono text-eyebrow uppercase text-rose-700 dark:text-rose-300">
                4 hướng nên tránh
              </h3>
              <ul className="mt-2 space-y-1.5">
                {result.bad.map((d) => (
