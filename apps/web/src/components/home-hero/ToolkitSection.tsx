        ...
        <div className="mt-8 space-y-6">
          {GROUPS.map((g, gi) => (
            <div key={g.label} className="rv-up" style={{ animationDelay: `${gi * 80}ms` }}>
              <p className="font-mono text-eyebrow uppercase text-primary/70">{g.label}</p>
                  ...
                  <span key={t.href} className="inline-flex items-center gap-1">
                    ...
                    {t.learn && (
                      <a
                        ...
                        className="-my-1 inline-flex items-center px-1 py-1.5 font-mono text-eyebrow uppercase text-primary underline underline-offset-2 transition-colors hover:text-primary"
                      >
                        học
                      </a>
                    )}
