  ...
  return (
    <div className="space-y-12">
      ...
      <section>
        ...
        <div className="mt-4 rounded-lg border border-gold/15 bg-card/40 p-6">
          <div className="space-y-1.5 font-sans text-base text-foreground/90">
...
function Sample({
  ...
  return (
    <div className="grid gap-2 rounded-lg border border-gold/10 bg-card/30 p-5 md:grid-cols-[180px_1fr] md:items-baseline md:gap-6">
      <div>
