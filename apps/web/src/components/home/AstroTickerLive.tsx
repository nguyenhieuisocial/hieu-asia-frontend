        ...
        <div className="flex min-h-[230px] items-stretch sm:min-h-[76px]">
          {state === null ? (
            ...
            <div className="grid grid-cols-2 items-stretch gap-x-2 gap-y-1 divide-y divide-primary/10 sm:flex sm:w-full sm:flex-nowrap sm:items-stretch sm:gap-0 sm:divide-y-0 sm:overflow-x-auto">
              ...
              <Link
                href="/gio-hoang-dao"
                className="group col-span-2 flex w-full shrink-0 items-center gap-1.5 self-center whitespace-nowrap px-4 py-3 font-mono text-eyebrow uppercase text-primary transition-colors hover:text-foreground active:text-foreground sm:col-auto sm:ml-auto sm:w-auto sm:px-5"
              >
                Xem giờ hoàng đạo
