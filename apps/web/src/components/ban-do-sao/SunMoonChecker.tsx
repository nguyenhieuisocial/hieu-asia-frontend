        ...
        {chart && (
          <div ref={resultRef} className="scroll-mt-24 space-y-4">
            ...
            <div className="rounded-xl border border-border bg-card/40 p-4">
              <p className="font-mono text-eyebrow uppercase text-gold/80">Tám hành tinh</p>
            ...
            {chart.angles && chart.ascendant && (
              <div className="rounded-xl border border-border bg-card/40 p-4">
                <p className="font-mono text-eyebrow uppercase text-gold/80">Bốn góc (trục đời)</p>
            ...
            {chart.nodes && (
              <div className="rounded-xl border border-border bg-card/40 p-4">
                <p className="font-mono text-eyebrow uppercase text-gold/80">Điểm nút Mặt Trăng</p>
                <p className="mt-2 text-xs text-muted-foreground">
            ...
            {balance && (
              <div className="rounded-xl border border-border bg-card/40 p-4">
                <p className="font-mono text-eyebrow uppercase text-gold/80">Cân bằng nguyên tố</p>
