 ...
 *
 * One of three preserved decorative roles for `font-editorial-display` post
 ...
 * / max-w-marketing / font-editorial-display.
 */
  ...
  return (
    ...
    >
      ...
      {variant === 'lotus' ? (
        ...
        <span className="font-editorial-display text-2xl italic text-gold/50">
          §
        </span>
      )}
      <span className="h-px flex-1 bg-gold/15" />
