  ...
  return (
    <Card className="border-red-500/40 bg-red-500/5">
      ...
      <CardContent className="space-y-4 text-sm text-foreground/85">
        ...
        {stage === 'level1' && (
          <div className="space-y-3 rounded-md border border-red-400/30 bg-card/40 p-4">
        ...
        {stage === 'level2' && (
          <div className="space-y-3 rounded-md border border-red-400/40 bg-card/40 p-4">
            <p className="font-semibold text-red-200">
              Bước cuối: gõ <code className="rounded bg-background px-2 py-0.5 text-red-100">{CONFIRM_TYPED}</code> để xác nhận
            </p>
            <Input
              value={typed}
              ...
              autoFocus
              className="border-red-400/40 bg-card/60 font-mono"
            />
            <div className="flex gap-2">
              <Button variant="ghost" onClick={reset} disabled={pending}>
                Hủy
