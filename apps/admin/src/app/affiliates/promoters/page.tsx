/**
 * /admin/affiliates/promoters — Wave 43.2
 *
 * Lists hieu_asia.affiliate_network with subtree stats + owner email.
 * Per-row actions: ban/unban (existing worker route) and reparent (new RPC).
 */
